  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="hidden sm:block">
              <h2 className="text-xl font-bold text-primary">Cabeceira Modulares</h2>
            </div>
          </div>
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && (
          <div className="md:hidden absolute top-20 left-0 right-0 bg-background/95 backdrop-blur-md border-b shadow-lg">
